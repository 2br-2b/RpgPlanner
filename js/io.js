    ...
    if (page.type === "mission") {
      for (const sec of campaign.sectionSchema) {
        ...
        if (sec.type === "table") {
          ...
          } else if (typeof raw === "object" && raw !== null && (raw.rows || []).length > 0) {
          ...
          if (typeof raw === "object" && raw !== null) {
            ...
            const hasAny = subheaders.some(sh => raw[sh]);
            if (hasAny) {
